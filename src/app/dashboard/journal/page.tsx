...
import { Plus, BookOpen, Calendar, Edit2, Trash2, CheckCircle2, XCircle, Battery, Brain, Target, X } from 'lucide-react'
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold mb-2">Journal de trading</h1>
